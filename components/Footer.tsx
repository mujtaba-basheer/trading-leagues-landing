            ...
            <div className="input">
              ...
              <span className="input">
                <input
                  ...
                  required
                  placeholder={
                    formContext?.status?.[2] === "failure"
                      ? "Invalid Mobile Number"
                      : "Enter Mobile Number"
                  }
                  className={formContext?.status?.[2]}
                  name="mobile"
                  id="mobile"
                />
              </span>
            </div>
            {formContext?.loading?.[2] ? (
              <span>
                <Loader color="#191B2A" />
              </span>
            ) : (
      ...
      <SocialSection>
        ...
        <div className="social">
          ...
          <div className="social-list">
            {socialData.map((x) => (
              <a href={x.url} target="_blank" rel="noreferrer" key={x.title}>
                <img
                  src={`${asset_prefix}/assets/social/${x.title}.svg`}
                  alt={x.title}
                />
              </a>
            ))}
